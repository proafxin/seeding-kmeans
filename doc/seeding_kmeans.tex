...
\begin{document}
	...
	\section{Conclusion}
	We argued that \texttt{k-means++} results may be wrong and discussed different seeding methods to improve \texttt{k-means} algorithms. Then we showed in terms of convergence and inertia that \texttt{ORSS} is usually the most stable initialization in terms of inertia.\clearpage
