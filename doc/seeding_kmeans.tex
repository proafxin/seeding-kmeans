...
\jmlrheading{119}{2020}{}{\today}{}{}{Masum Billal, Md. Walid Amin Khan and Farhad Alam Bhuiyan}
\ShortHeadings{Seeding \texttt{k-means}}{M. Billal, W. Khan, F. Alam}
\begin{document}
	...
	However, to make things smoother, one can also choose to use the following as the probability of $x$ being chosen as the first center.
		...
		\end{align*}
	Notice that the variance of $S$ is in the denominator. We can consider $p(x)$ as if it is the amount of variance explained by $x$. Also, this version of $p(x)$ is computationally much cheaper than $\sum_{\y\in\X}\|\x-\y\|^2$. Therefore, we considered $p(x)$ proportional to $\|x-\mu\|^2$ for choosing $x$ as the first center in our experiments.
