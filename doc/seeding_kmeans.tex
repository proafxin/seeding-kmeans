...
\begin{document}
	...
	Another very important consideration could be deep learning although it's still not concrete. Recently there have been some studies where deep learning has been used for clustering or clustering has been used as an extra embedding layer in deep learning (see \textcite{Li_Pi_Lin_Cui_2020}).
