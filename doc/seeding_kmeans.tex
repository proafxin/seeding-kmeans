...
\begin{document}
	...
	This gives us the following result.
		...
		\end{theorem}
	We believe this estimate is not tight at all and it can be improved by a huge margin. For example, I had ideas of using Abel's summation formula \citep[Theorem $4.2$]{apostol} and Taylor series to approximate the sum on the right side of equation \eqref{eqn:4} and get a tighter bound. However, I was happy with the experimental results and therefore, I decided to not spend any more time in finding a tighter bound. I may work on this in future, but right now I do not have any plans to improve this bound.
