	...
	This holds for any seeding technique.
		\begin{theorem}
			For a set of points $S$ and a set of centers $C$, we have
				\begin{align*}
					\I(S) & \leq \I_{opt}(S)+n\|\mu_S-\mu_C\|^2+\dfrac{n}{k}\I_{opt}(C)
				\end{align*}
