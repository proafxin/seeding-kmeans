...
\begin{document}
	...
	The comparison of inertia for different initialization is shown in tables \ref{tbl:boston}, \ref{tbl:wine}, \ref{tbl:airlines}.
		\begin{table}
			\begin{center}
				...
				\end{tabular}
			\caption{Results on Boston housing data set}
			\label{tbl:boston}
			\end{center}
		\end{table}
		...
		\begin{table}
			\begin{center}
				...
				\end{tabular}
				\caption{Results on Wine data set}
				\label{tbl:wine}
			\end{center}
		...
		\begin{table}
			\begin{center}
				...
				\end{tabular}
				\caption{Results on Airlines data set}
				\label{tbl:airlines}
			\end{center}
