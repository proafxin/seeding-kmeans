	...
	The comparison of inertia and number of iterations required for convergence are shown in tables \ref{tbl:boston}, \ref{tbl:wine}, \ref{tbl:airlines}. 
		...
		\begin{table}
			\begin{center}
				\begin{tabular}{|l|l|l|}
					\hline
					Number of clusters & kmeans++ (scikit-learn) inertia & kmeans++ (our implementation) inertia\\\hline
					5 & 17706689.573774982& 17711385.61029025\\\hline
					10 & 5761674.929143367& 6434641.098051261\\\hline
					15 & 2007444.7098438586& 2255902.212313077\\\hline
					20 & 1099395.4420880969& 1194727.658029051\\\hline
				\end{tabular}
				\caption{Cloud dataset inertia - no preprocessor}
		...
		\begin{table}
			\begin{center}
				\begin{tabular}{|l|l|l|}
					...
					15 & 817.4296830232086 & 833.2041864088023\\\hline
					20 & 519.1784696946825 & 543.6392985861094\\\hline
				\end{tabular}
				\caption{Cloud dataset inertia - standard scaler}
		...
		\begin{table}
			\begin{center}
				\begin{tabular}{|l|l|l|}
					...
					15 & 17.941355048689374 & 18.50259622163847\\\hline
					20 & 11.362562342560503 & 11.7818373139353\\\hline
				\end{tabular}
				\caption{Cloud dataset inertia - standard scaler}
