	...
	The comparison of inertia and number of iterations required for convergence are shown in tables \ref{tbl:boston}, \ref{tbl:wine}, \ref{tbl:airlines}. 
		...
		\begin{table}
			\begin{center}
				\begin{tabular}{|l|l|l|}
					\hline
					Number of clusters & Inertia (scikit-learn) & kmeans++ (our)\\\hline
				...
				\end{tabular}
				\caption{Cloud data set results}
		...
		\begin{table}
			\begin{center}
				...
				\end{tabular}
				\caption{Cloud data set results (standardized)}
		...
		\begin{table}
			\begin{center}
				...
				\end{tabular}
				\caption{Cloud data set results (scaled)}
