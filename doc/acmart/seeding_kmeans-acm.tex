...
\author{Md. Walid Amin Khan}
\email{walid.sec3.034@gmail.com}
\author{Farhad Alam Bhuiyan}
...
\begin{document}
	...
	\keywords{clustering, \texttt{k-means}, seeding centers, inertia optimization, \texttt{k-means++}}
	...
	Thus, we can write inertia as 
		\begin{align*}
			\mathcal{I} & = \sum_{x\in S}\min_{c\in C}\|x-c\|^2\\
			D(x)^2 & = \min_{c\in C}\|x-c\|^2\\
			D(x)^2 & \leq \|x-\mu_{C}\|^2+\dfrac{1}{k}\sum_{c\in C}\|\mu_{C}-c\|^2\\
			\mathcal{I} & \leq \sum_{x\in S}\left(\|x-\mu_C\|^2+\dfrac1k\mathcal{I}_C\right)\\
			& = \sum_{x\in S}\|x-\mu_C\|^2+\dfrac nk\mathcal{I}_C\\
			& = \sum_{x\in S}\|x-\mu\|^2+n\|\mu-\mu_C\|^2+\dfrac nk\mathcal{I}_C
		\end{align*}
